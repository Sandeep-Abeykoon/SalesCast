  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        width: 1000,
        height: 1000,
        decoration: BoxDecoration(color: Colors.white12.withOpacity(0.6)),
            ...
            child: Column(
              children: <Widget>[
                Padding(
                    ...
                    child: Image(
                        image: AssetImage(
                            "lib/assets/images/OnBoardImages/Image_2.png"))),
                ...
                Text(
                  "Let's begin by login or sign in",
                  style: TextStyle(
                      fontFamily: "Poppins",
                      fontSize: 24,
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: const [
                          Image(
                            image: AssetImage(
                                "lib/assets/images/google-logo-9808.png"),
                            height: 18.0,
                            width: 24,
                          ),
                          Padding(
