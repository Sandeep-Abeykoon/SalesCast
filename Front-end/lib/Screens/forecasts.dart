      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text('Forecasts',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
            bottom: TabBar(
              isScrollable: true,
              ...
              tabs: [
                Padding(
                  padding: EdgeInsets.fromLTRB(30, 0, MediaQuery.of(context).size.width*0.2, 0),
                    child: Tab(icon: Icon(Icons.table_chart),)),
                Padding(
                  padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width*0.2, 0, 30, 0),
