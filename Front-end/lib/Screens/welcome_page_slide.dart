            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image(
                    image: AssetImage(
                        "lib/assets/images/OnBoardImages/Student_and_teacher_studying_financial_graph_growth-removebg-preview.png"),
                  ...
                  Text(
                    "Let's start the journey with Salescast",
                    style: TextStyle(
                        fontFamily: "Poppins",
                        fontSize: 18,
                        color: Colors.grey),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image(
                    image: AssetImage(
                        "lib/assets/images/OnBoardImages/competitor_analysis_16-removebg-preview.png"),
                    height: MediaQuery.of(context).size.height * 0.4,
                    width: MediaQuery.of(context).size.width,
                  ),
                  Text(
                  ...
                  Padding(
                      ...
                      child: Text(
                        "Get the detailed forecasts of your favourite products.",
                        style: TextStyle(
                            fontFamily: "Poppins",
                            fontSize: 18,
                            color: Colors.grey),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image(
                    image: AssetImage(
                        "lib/assets/images/OnBoardImages/rebranding_5-removebg-preview.png"),
                    height: MediaQuery.of(context).size.height * 0.4,
                    width: MediaQuery.of(context).size.width,
                  ),
                  SizedBox(
                  ...
                  Padding(
                      ...
                      child: Text(
                        "Compare the forecasts of your product brand with the highest demanding product brands.",
                        style: TextStyle(
                            fontFamily: "Poppins",
                            fontSize: 18,
                            color: Colors.grey),
