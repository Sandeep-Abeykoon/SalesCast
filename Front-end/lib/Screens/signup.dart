...
=======
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5,),
                        AppSmallText(text: "Create your profile to start journey", color: Colors.black45),
                      ],
                    ),
                  ),
                  const SizedBox(
                  ...
                  reusableTextfield("Enter User Name", Icons.person_outlined, false,_userNameTextController,false),
                  const SizedBox(
                    height: 20,
                  ),
                  reusableTextfield("Enter Email", Icons.email_outlined, false,_emailTextController,true),
                  const SizedBox(
                    height: 20,
                  ),
                  reusableTextfield("Enter a Strong Password", Icons.password, true,_passwordTextController,false ),
                  const SizedBox(
                    height: 30,
                  ),
                  // logInSignUpButton(context, false, (){
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          _formkey.currentState!.validate()){
                            ...
                            _signIn(_emailTextController.text, _passwordTextController.text);
